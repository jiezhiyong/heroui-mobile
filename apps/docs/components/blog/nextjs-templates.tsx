...
const frameworks = [
  {
    ...
    isExternal: true,
    description:
      "A Next.js 13 with app directory template pre-configured with HeroUiMobile (v2) and Tailwind CSS.",
  ...
  },
  {
    ...
    isExternal: true,
    description:
      "A Next.js 13 with pages directory template pre-configured with HeroUiMobile (v2) and Tailwind CSS.",
    icon: <NewNextJSIcon height={40} width={40} />,
