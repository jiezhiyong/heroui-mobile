---
title: Theme
description: Learn how to customize your application's appearance using HeroUiMobile's TailwindCSS plugin.
---

# Theme

Theming allows you to maintain a consistent look and feel across your application. HeroUiMobile provides theme customization through a TailwindCSS plugin based on [tw-colors](https://github.com/L-Blondy/tw-colors), enabling you to easily customize colors, layouts and other UI elements.
...
The first step to using HeroUiMobile's theming capability is adding the `heroui` plugin to your
...
HeroUiMobile supports nested themes, allowing you to apply different themes to different sections
of your application:
...
HeroUiMobile enables you to apply TailwindCSS styles based on the currently active theme. Below are
