---
title: Colors
description: Learn how to configure and customize colors with HeroUiMobile.
---

# Colors

HeroUiMobile's plugin enables you to personalize the semantic colors of the theme such as `primary`,
...
HeroUiMobile offers a default color palette right out of the box, perfect for when you're
...
HeroUiMobile creates CSS variables using the format `--prefix-colorname-shade` for each semantic color. By
