...
description: HeroUiMobile allows you to override the default styles of the components in several ways.
---
...
Some HeroUiMobile components have slots that can be styled individually using the `classNames` prop. The [CircularProgress](/docs/components/circular-progress) component has the following slots:
