---
title: Layout
description: HeroUiMobile offers a set of layout options to customize the theme.
---

# Layout

HeroUiMobile provides layout customization options for spacing, fonts, and other visual properties. Layout tokens help maintain consistency across components without modifying Tailwind CSS defaults.
...
HeroUiMobile creates CSS variables using the format `--prefix-prop-name-scale` for each layout token. By
