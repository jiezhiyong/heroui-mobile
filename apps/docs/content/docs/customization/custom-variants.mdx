...
description: Learn how to create new variants for the HeroUiMobile components.
---

# Custom Variants

HeroUiMobile allows you to create new variants for components by extending and customizing their styles. You can override the component's `variants`, `defaultVariants` and `compoundVariants`.
...
/**
 * BaseComponent -> HeroUiMobile component to extend
