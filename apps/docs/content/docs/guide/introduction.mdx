---
title: Introduction
description: HeroUiMobile is a UI library for React that helps you build beautiful and accessible user interfaces. Created on top of Tailwind CSS and React Aria.
---

# Introduction

Welcome to the HeroUiMobile documentation!
...
it's a UI library for React that helps you build beautiful and accessible user interfaces. Created on top of
[Tailwind CSS](https://v3.tailwindcss.com/) and [React Aria](https://react-spectrum.adobe.com/react-aria/index.html).

it's primary goal is to streamline the development process, offering a beautiful and adaptable system design for an enhanced user experience.

---

## is't a copy-paste library?

No, it's not a copy-paste library. All components are available through `npm` and can be installed individually or as a whole package.

## How is't different from TailwindCSS?
...
## How is't different from TailwindCSS components libraries?
...
<div className="text-default-600 dark:text-default-500">
  ...
  <Spacer y={2}/>
  In contrast to these libraries, it's a complete UI library that provides a set of accessible and
  customizable components, hooks, and utilities.
</div>

## How it deals with TailwindCSS classes conflicts?
...
## Does it use runtime CSS?

<div className="text-default-600 dark:text-default-500">
  No. As it uses TailwindCSS as its style engine, it generates CSS at build time, eliminating
  the need for runtime CSS. This means that it's fully compatible with the latest React and
  Next.js versions.
</div>
...
<div className="text-default-600 dark:text-default-500">
  Yes, it's written in TypeScript and has full support for it.
</div>

## Can I use it with other front-end frameworks or libraries, such as Vue or Angular?

<div className="text-default-600 dark:text-default-500">
  No, it's specifically designed for React as it's built on top of React Aria. However, you
  can still use the HeroUI components styling part with other frameworks or libraries.
</div>

## Why does it use Framer Motion?
...
<div className="text-default-600 dark:text-default-500">
  ...
  handle these animations in a more straightforward and performant way. In addition, it's
...
We're excited to see the community adopt HeroUiMobile, raise issues, and provide feedback.
...
PRs on **HeroUiMobile** are always welcome, please see our [contribution guidelines](https://github.com/jiezhiyong/heroui-mobile/blob/main/CONTRIBUTING.md) to learn how you can contribute to this project.
