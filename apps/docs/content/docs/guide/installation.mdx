---
title: Installation
description: Get started with HeroUiMobile in the official documentation, and learn more about all our features!
---
...
Using the CLI is now the easiest way to start a HeroUiMobile project. You can initialize your project and add components directly via the CLI:
...
Once your HeroUiMobile project is ready to develop, you can add individual components using the CLI. For example, to add a button component:
...
If you prefer not to use the CLI, you may try either global installation or individual installation to set up HeroUiMobile in your project:

### Global Installation

The easiest way to get started with HeroUiMobile is to use the global installation, which means
that all the components are imported from a single package.

Follow the steps below to install all HeroUiMobile components:

<Steps>

#### Install Packages

To install HeroUiMobile, run one of the following commands in your terminal:
...
**Note**: This step is only for those who use `pnpm` to install. If you install HeroUiMobile using other package managers, you may skip this step.
</Blockquote>
...
HeroUiMobile is built on top of Tailwind CSS, so you need to install Tailwind CSS first. You can follow the official
...
HeroUiMobile is also available as individual packages. You can install each package separately. This
is useful if you want to reduce the size of your CSS bundle as it will only include styles for the components
you're actually using.

<Blockquote color="primary">
**Note**: JavaScript bundle size will not change due to tree shaking support in HeroUiMobile.
</Blockquote>
...
HeroUiMobile is compatible with your preferred framework. We have compiled comprehensive, step-by-step tutorials for the following frameworks:
