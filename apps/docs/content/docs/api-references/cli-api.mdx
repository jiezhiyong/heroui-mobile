---
title: HeroUiMobile CLI
description: API References for HeroUiMobile CLI
---
...
Here's the API reference for the `HeroUiMobile CLI`.
...
Commands:
  ...
  add [options] [targets...]         1. Adds components to your project
                                     2. Adds HeroUiMobile Chat codebase to your project
...
Initialize a new HeroUiMobile project with official templates.
...
```codeBlock bash
# Initialize a new HeroUiMobile project with the app template, named my-heroui-app
...
```codeBlock bash
HeroUiMobile CLI v0.2.1

┌  Create a new project
│
◇  Select a template (Enter to select)
│  ● App (A Next.js 15 with app directory template pre-configured with HeroUiMobile (v2) and Tailwind CSS.)
│  ○ Pages (A Next.js 15 with pages directory template pre-configured with HeroUiMobile (v2) and Tailwind CSS.)
│  ○ Vite (A Vite template pre-configured with HeroUiMobile (v2) and Tailwind CSS.)
│  ○ Remix (A Remix template pre-configured with HeroUiMobile (v2) and Tailwind CSS.)
│  ○ Laravel (A Laravel template pre-configured with HeroUiMobile (v2) and Tailwind CSS.)
│
...
1. Add HeroUiMobile components to your project.
2. Add HeroUiMobile Chat codebase to your project.
...
> 4. Add HeroUiMobile Chat codebase to your project
...
- `-d --directory` [string] Add HeroUiMobile Chat codebase to a specific directory
...
Upgrade the HeroUiMobile components to the latest version.
...
- `-p --packagePath` [string] The path to the package.json file
- `-a --all` [boolean] Upgrade all the HeroUiMobile components (default: `false`)
...
Remove HeroUiMobile components from your project.

> **Note**: If there are no HeroUiMobile components after removing, the required content will also be removed
...
- `-p --packagePath` [string] The path to the package.json file
- `-a --all` [boolean] Remove all the HeroUiMobile components (default: `false`)
- `-tw --tailwindPath` [string] The path to the tailwind.config file file
- `--prettier` [boolean] Add prettier format in the add content which required installed prettier - (default: `false`)
...
> 2. Check whether the HeroUiMobile components `required dependencies are installed` in the project
...
HeroUiMobile CLI: ❌ Your project has 1 issue that require attention
