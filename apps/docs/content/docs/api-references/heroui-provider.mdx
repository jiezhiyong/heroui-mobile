---
title: HeroUiMobile Provider
description: API References for HeroUiMobile Provider
---

# HeroUiMobile Provider
...
- **Description**:
  ...
  animations in HeroUiMobile Components are still omitted if the `disableAnimation` prop is `true`.
- **Type**: `boolean`
