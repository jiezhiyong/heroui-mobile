---
title: Next.js
description: How to use HeroUiMobile with Next.js
---
...
To use HeroUiMobile in your Next.js project, you need to follow the steps below, depending on your project structure.

## App Directory Setup

Next.js 13's `app/` directory uses Server Components by default. HeroUiMobile components can be imported directly in Server Components since we add `use client` at build time.

### HeroUiMobile CLI (recommended)

If you are starting a new project, you can use the HeroUiMobile CLI to create a new project with HeroUiMobile pre-configured:
...
If you are starting a new project, you can run one of the following commands to create a Next.js project pre-configured with HeroUiMobile:
...
In your Next.js project, run one of the following commands to install HeroUiMobile:
...
> **Note**: HeroUiMobile automatically adds two themes, `light` and `dark`, to your application. You can use any
...
### Use HeroUiMobile Components

Now you can import any HeroUiMobile component directly in your Server Components without needing to use
...
Now you can import any HeroUiMobile component wherever you want:
