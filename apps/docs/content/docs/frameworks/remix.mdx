---
title: Remix
description: How to use HeroUiMobile with Remix
---
...
To use HeroUiMobile in your Remix project, you need to follow the following steps:

### Using HeroUiMobile + Remix template

If you are starting a new project, you can run one of the following commands to create a Remix project pre-configured with HeroUiMobile:
...
In your Remix project, run one of the following command to install HeroUiMobile:
