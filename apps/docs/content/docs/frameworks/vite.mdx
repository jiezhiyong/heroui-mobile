---
title: Vite
description: How to use HeroUiMobile with Vite
---
...
To use HeroUiMobile in your Vite project, you need to follow the following steps:

### HeroUiMobile CLI (recommended)

If you are starting a new project, you can use the [HeroUiMobile CLI](/docs/guide/cli) to create a new project with HeroUiMobile pre-configured:
...
### Using HeroUiMobile + Vite template

If you are starting a new project, you can run one of the following commands to create a Vite project pre-configured with HeroUiMobile:
...
In your Vite React project, run one of the following command to install HeroUiMobile:
...
After installing HeroUiMobile, you need to set up the `HeroUIProvider` at the `root` of your application.
