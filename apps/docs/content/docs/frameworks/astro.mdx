---
title: Astro
description: How to use HeroUiMobile with Astro
---
...
To use HeroUiMobile in your Astro project, you need to follow the following steps:

<Steps>

### Install React

HeroUiMobile is built on top of React, so you need to install React first. You can follow the official
[integration guide](https://docs.astro.build/en/guides/integrations-guide/react/) to install React.


### Install HeroUiMobile

In your Astro project, run one of the following command to install HeroUiMobile:
...
Now you can import HeroUiMobile components and use them in your Astro project:
...
some functionalities of HeroUiMobile components may not work properly.
