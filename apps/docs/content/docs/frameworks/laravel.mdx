---
title: Laravel
description: How to use HeroUiMobile with Laravel
---
...
To use HeroUiMobile in your Laravel project, you need to follow the following steps:

### Using HeroUiMobile + Laravel template

If you are starting a new project, you can run one of the following commands to create a Laravel project pre-configured with HeroUiMobile:
...
In your Laravel project, run one of the following command to install HeroUiMobile:
