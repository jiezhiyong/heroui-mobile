---
title: "Introducing HeroUiMobile"
description: "HeroUiMobile is the new identity for NextUI, bringing the same beautiful components and features you love under a new name."
date: "2025-01-16"
...
<img
  ...
  width={700}
  height={350}
  alt="Introducing HeroUiMobile"
  className="w-full border border-transparent dark:border-default-200/50 object-fit rounded-xl shadow-lg"
/>

We're excited to announce that **HeroUiMobile** is the new identity for NextUI, bringing the same beautiful components and features you love but now under a _new_ name.
...
Additionally, we want to avoid any confusion about our library being created or maintained by the Next.js team. HeroUiMobile better reflects our independent identity and broader mission.
...
This will automatically update your project to use HeroUiMobile.
...
- HeroUiMobile v3 with refreshed component designs, reduced bundle size, and more personalization options
- And much more!
