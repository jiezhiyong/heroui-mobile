...
<img
  ...
  width={700}
  height={350}
  alt="HeroUiMobile v2.7.0"
  className="w-full border border-transparent dark:border-default-200/50 object-fit rounded-xl shadow-lg"
/>

HeroUiMobile version **v2.7.0** introduces the highly anticipated Toast component, along with exciting new features including NumberInput component, Theme Generator, new Spinner variants, Table virtualization support, and numerous improvements and bug fixes.
...
1. Upgrading HeroUiMobile using the `cli`
...
2. Upgrading HeroUiMobile using package managers
...
The new Toast component provides a flexible and accessible way to show temporary notifications in your application. It comes with built-in support for different placements, variants, and animations. Inspired by [Sonner](https://sonner.emilkowal.ski/), our Toast component brings a beautiful, minimal, and customizable notification system to HeroUiMobile.
...
We're building an exciting new application that will revolutionize frontend development with HeroUiMobile, making your workflow smoother than ever. Stay tuned for updates! 🔥
...
Special thanks to HeroUiMobile Team members [@wingkwong](https://github.com/wingkwong), [@macci001](https://github.com/macci001), [@vinroger](https://github.com/vinroger),
...
PR's on HeroUiMobile are always welcome, please see our [contribution guidelines](https://github.com/heroui-inc/heroui/blob/main/CONTRIBUTING.md) to learn how you can contribute to this project.
